            ...
            <div class="row">
              <div class="col-lg-12 grid-margin">
                <div class="card">
                	...
                	<a href="olap.php" class="btn btn-gradient-primary me-2" >Kembali</a>
                	</div>
                  <div class="card-body">
                    <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=adw1" style="height:600px; width: 1000px;"></iframe>
                  </div>
                </div>
              </div>
                </div>
